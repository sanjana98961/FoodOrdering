...
const SignUp = () => {
  ...
  return (
    <>
      <InnerBanner title="SIGN UP" bg="/images/menu.jpg" />
          ...
          <div className="signInBox m-auto w-[500px] p-3">
            <form className="w-full form">
              ...
              <div className="or position-relative mt-1 flex items-center justify-center">
                ...
                <br/>
              <Button className="w-full authBtn"><FcGoogle className="mr-2" style={{fontSize:"30px"}}/> Sign up with google</Button>
              <br/>
              <p className="text-center mt-3">Already have an account? <Link href={"/signin"}>Sign In</Link></p>
            </form> 
          </div>
        </div>
      </section> 
